        ...
        <div className="flex w-full mt-2 space-x-3 max-w-xs ml-auto justify-end">
          <div>
            ...
            <div className="border border-primaryDark px-1 py-2">
              ...
              <Link href="/" className="text-xs text-primaryDark hover:bg-light/40">
      ...
      {el.incoming ? (
        <div className="flex w-full mt-2 space-x-3 max-w-xs">
          ...
          <div>
            ...
            <div className="border border-primaryDark px-1 py-2">
              <p className="text-xs">Nitin.nsw</p>
              <Link href='/' className="text-xs text-primaryDark hover:bg-light/30">
                12nitinkumaryd@gmail.com
              </Link>
            </div>
            <span className="text-xs text-primaryDark leading-none">2 min ago</span>
        ...
        <div className="flex w-full mt-2 space-x-3 max-w-xs">
          ...
          <div>
            <div className="bg-primaryback text-dark p-3 rounded-r-lg rounded-bl-lg">
              ...
              <p className="text-sm px-2 py-1 bg-dark/70 rounded-tl-xl text-light">
                <BsReply className="text-light"/>{el.reply}
              </p>
            </div>
            <span className="text-xs text-primaryDark leading-none">2 min ago</span>
          </div>
...
const MsgTypes = { Timeline, TextMsg, MediaMsg, ReplyMsg, LinkMsg, DocMsg };
